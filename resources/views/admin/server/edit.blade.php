            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.server.update', $server->id) }}">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="name" value="{{ old('name')?old('name'):$server->name }}">
                            ...
                            <div class="form-group{{ $errors->has('ip') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="ip" value="{{ old('ip')?old('ip'):$server->ip }}">
                            ...
                            <div class="form-group{{ $errors->has('port') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="port" value="{{ old('port')?old('port'):$server->port }}">
                            ...
                            <?php $selectedGameId =  old('game_id')?old('game_id'):$server->game_id; ?>
                            ...
                            <?php $status =  old('status')?old('status'):$server->status; ?>
